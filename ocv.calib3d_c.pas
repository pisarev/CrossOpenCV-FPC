...
type
  TcvCalibrateCamera2 = function(const object_points: pCvMat; const image_points: pCvMat; const point_counts: pCvMat; image_size: TCvSize; camera_matrix: pCvMat; distortion_coeffs: pCvMat; rotation_vectors: pCvMat ; translation_vectors: pCvMat ; flags: Integer ; term_crit: TCvTermCriteria  ): double; cdecl;
  ...
  TcvFindChessboardCorners = function(const image: Pointer; pattern_size: TCvSize; corners: pCvPoint2D32f; corner_count: pInteger = nil; flags: Integer = CV_CALIB_CB_ADAPTIVE_THRESH + CV_CALIB_CB_NORMALIZE_IMAGE): Integer; cdecl;
  TcvFindFundamentalMat = function(const points1: pCvMat; const points2: pCvMat; fundamental_matrix: pCvMat; method: Integer = CV_FM_RANSAC; param1: double = 3; param2: double = 0.99; status: pCvMat = nil): Integer; cdecl;
  TcvFindHomography = function(const src_points: pCvMat; const dst_points: pCvMat; homography: pCvMat; method: Integer = 0; ransacReprojThreshold: double = 3; mask: pCvMat = nil): Integer; cdecl;
  ...
  TcvStereoCalibrate = function(const object_points: pCvMat; const image_points1: pCvMat; const image_points2: pCvMat; const npoints: pCvMat; camera_matrix1: pCvMat; dist_coeffs1: pCvMat; camera_matrix2: pCvMat; dist_coeffs2: pCvMat; image_size: TCvSize; R: pCvMat; T: pCvMat; E: pCvMat ; F: pCvMat ; term_crit: TCvTermCriteria ; flags: Integer  ): double; cdecl;
  TcvStereoRectifyUncalibrated = function(const points1: pCvMat; const points2: pCvMat; const F: pCvMat; img_size: TCvSize; H1: pCvMat; H2: pCvMat; threshold: double = 5): Integer; cdecl;
  TcvCalcMatMulDeriv = procedure(const A: pCvMat; const B: pCvMat; dABdA: pCvMat; dABdB: pCvMat); cdecl;
  TcvCalibrationMatrixValues = procedure(const camera_matrix: pCvMat; image_size: TCvSize; aperture_width: double = 0; aperture_height: double = 0; fovx: PDouble = nil; fovy: PDouble = nil; focal_length: PDouble = nil; principal_point: PCvPoint2D64f = nil; pixel_aspect_ratio: PDouble = nil); cdecl;
  ...
  TcvFindExtrinsicCameraParams2 = procedure(const object_points: pCvMat; const image_points: pCvMat; const camera_matrix: pCvMat; const distortion_coeffs: pCvMat; rotation_vector: pCvMat; translation_vector: pCvMat; use_extrinsic_guess: Integer = 0); cdecl;
  ...
  TcvGetOptimalNewCameraMatrix = procedure(const camera_matrix: pCvMat; const dist_coeffs: pCvMat; image_size: TCvSize; alpha: double; new_camera_matrix: pCvMat; new_imag_size: TCvSize ; valid_pixel_ROI: PCvRect = nil; center_principal_point: Integer = 0); cdecl;
  TcvInitIntrinsicParams2D = procedure(const object_points: pCvMat; const image_points: pCvMat; const npoints: pCvMat; image_size: TCvSize; camera_matrix: pCvMat; aspect_ratio: double = 1); cdecl;
  TcvPOSIT = procedure(posit_object: PCvPOSITObject; imagePoints: pCvPoint2D32f; focal_length: double; criteria: TCvTermCriteria; rotation_matrix: TCvMatr32f; translation_vector: TCvVect32f); cdecl;
  TcvProjectPoints2 = procedure(const object_points: pCvMat; const rotation_vector: pCvMat; const translation_vector: pCvMat; const camera_matrix: pCvMat; const distortion_coeffs: pCvMat; image_points: pCvMat; dpdrot: pCvMat = nil; dpdt: pCvMat = nil; dpdf: pCvMat = nil; dpdc: pCvMat = nil; dpddist: pCvMat = nil; aspect_ratio: double = 0); cdecl;
  ...
  TcvReprojectImageTo3D = procedure(const disparityImage: pCvMat; _3dImage: pIplImage; const Q: pCvMat; handleMissingValues: Integer = 0); cdecl;
  TcvRQDecomp3x3 = procedure(const matrixM: pCvMat; matrixR: pCvMat; matrixQ: pCvMat; matrixQx: pCvMat = nil; matrixQy: pCvMat = nil; matrixQz: pCvMat = nil; eulerAngles: PCvPoint3D64f = nil); cdecl;
  TcvStereoRectify = procedure(const camera_matrix1: pCvMat; const camera_matrix2: pCvMat; const dist_coeffs1: pCvMat; const dist_coeffs2: pCvMat; image_size: TCvSize; const R: pCvMat; const T: pCvMat; R1: pCvMat; R2: pCvMat; P1: pCvMat; P2: pCvMat; Q: pCvMat ; flags: Integer ; alpha: double ; new_image_size: TCvSize ; valid_pix_ROI1: PCvRect ; valid_pix_ROI2: PCvRect  ); cdecl;
  ...
  TcvValidateDisparity = procedure(disparity: pCvArr; const cost: pCvArr; minDisparity: Integer; numberOfDisparities: Integer; disp12MaxDiff: Integer = 1); cdecl;
...
const
  Calib3dLibName = calib3d_lib;
var
  Calib3dLibHandle: {$IFDEF FPC}TLibHandle{$ELSE}THandle{$IFEND};
...
procedure Initialize(const Handle: {$IFDEF FPC}TLibHandle{$ELSE}THandle{$IFEND}; const RaiseError: Boolean);
begin
  cvCalibrateCamera2 := GetProcAddress(Handle, 'cvCalibrateCamera2', RaiseError);
  cvCheckChessboard := GetProcAddress(Handle, 'cvCheckChessboard', RaiseError);
  cvCreatePOSITObject := GetProcAddress(Handle, 'cvCreatePOSITObject', RaiseError);
  cvCreateStereoBMState := GetProcAddress(Handle, 'cvCreateStereoBMState', RaiseError);
  cvFindChessboardCorners := GetProcAddress(Handle, 'cvFindChessboardCorners', RaiseError);
  cvFindFundamentalMat := GetProcAddress(Handle, 'cvFindFundamentalMat', RaiseError);
  cvFindHomography := GetProcAddress(Handle, 'cvFindHomography', RaiseError);
  cvGetValidDisparityROI := GetProcAddress(Handle, 'cvGetValidDisparityROI', RaiseError);
  cvRANSACUpdateNumIters := GetProcAddress(Handle, 'cvRANSACUpdateNumIters', RaiseError);
  cvRodrigues2 := GetProcAddress(Handle, 'cvRodrigues2', RaiseError);
  cvStereoCalibrate := GetProcAddress(Handle, 'cvStereoCalibrate', RaiseError);
  cvStereoRectifyUncalibrated := GetProcAddress(Handle, 'cvStereoRectifyUncalibrated', RaiseError);
  cvCalcMatMulDeriv := GetProcAddress(Handle, 'cvCalcMatMulDeriv', RaiseError);
  cvCalibrationMatrixValues := GetProcAddress(Handle, 'cvCalibrationMatrixValues', RaiseError);
  cvComposeRT := GetProcAddress(Handle, 'cvComposeRT', RaiseError);
  cvComputeCorrespondEpilines := GetProcAddress(Handle, 'cvComputeCorrespondEpilines', RaiseError);
  cvConvertPointsHomogeneous := GetProcAddress(Handle, 'cvConvertPointsHomogeneous', RaiseError);
  cvCorrectMatches := GetProcAddress(Handle, 'cvCorrectMatches', RaiseError);
  cvDecomposeProjectionMatrix := GetProcAddress(Handle, 'cvDecomposeProjectionMatrix', RaiseError);
  cvDrawChessboardCorners := GetProcAddress(Handle, 'cvDrawChessboardCorners', RaiseError);
  cvFindExtrinsicCameraParams2 := GetProcAddress(Handle, 'cvFindExtrinsicCameraParams2', RaiseError);
  cvFindStereoCorrespondenceBM := GetProcAddress(Handle, 'cvFindStereoCorrespondenceBM', RaiseError);
  cvGetOptimalNewCameraMatrix := GetProcAddress(Handle, 'cvGetOptimalNewCameraMatrix', RaiseError);
  cvInitIntrinsicParams2D := GetProcAddress(Handle, 'cvInitIntrinsicParams2D', RaiseError);
  cvPOSIT := GetProcAddress(Handle, 'cvPOSIT', RaiseError);
  cvProjectPoints2 := GetProcAddress(Handle, 'cvProjectPoints2', RaiseError);
  cvReleasePOSITObject := GetProcAddress(Handle, 'cvReleasePOSITObject', RaiseError);
  cvReleaseStereoBMState := GetProcAddress(Handle, 'cvReleaseStereoBMState', RaiseError);
  cvReprojectImageTo3D := GetProcAddress(Handle, 'cvReprojectImageTo3D', RaiseError);
  cvRQDecomp3x3 := GetProcAddress(Handle, 'cvRQDecomp3x3', RaiseError);
  cvStereoRectify := GetProcAddress(Handle, 'cvStereoRectify', RaiseError);
  cvTriangulatePoints := GetProcAddress(Handle, 'cvTriangulatePoints', RaiseError);
  cvValidateDisparity := GetProcAddress(Handle, 'cvValidateDisparity', RaiseError);
end;

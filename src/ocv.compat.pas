...
type
  TcvCalcEMD = function(const signature1: pfloat; size1: Integer; const signature2: pfloat; size2: Integer; dims: Integer; dist_type: Integer = CV_DIST_L2; dist_func: TCvDistanceFunction = nil; lower_bound: pfloat = nil; user_param: Pointer = nil): float; cdecl;
  TcvContourBoundingRect = function(point_set: Pointer; update: Integer = 0): TCvRect; cdecl;
  TcvFindChessBoardCornerGuesses = function(const arr: Pointer; thresharr: Pointer; storage: PCvMemStorage; pattern_size: TCvSize; corners: PCvPoint2D32f; corner_count: pInteger): Integer; cdecl;
  TcvGetStarKeypoints = function(const img: PCvArr; storage: PCvMemStorage; params: TCvStarDetectorParams  ): pCvSeq; cdecl;
  TcvHoughLines = function(image: PCvArr; rho: Double; theta: Double; threshold: Integer; lines: pfloat; linesNumber: Integer): Integer; cdecl;
  TcvHoughLinesP = function(image: PCvArr; rho: Double; theta: Double; threshold: Integer; lineLength: Integer; lineGap: Integer; lines: pInteger; linesNumber: Integer): Integer; cdecl;
  TcvHoughLinesSDiv = function(image: PCvArr; rho: Double; srn: Integer; theta: Double; stn: Integer; threshold: Integer; lines: pfloat; linesNumber: Integer): Integer; cdecl;
  TcvMatArray_ = function(rows: Integer; cols: Integer; type_: Integer; count: Integer; data: Pointer = nil): TCvMat; cdecl;
  TcvMean = function(const image: PCvArr; const mask: PCvArr = nil): Double; cdecl;
  TcvMSERParams_ = function(delta: Integer = 5; min_area: Integer = 60; max_area: Integer = 14400; max_variation: float = 0.25; min_diversity: float = 0.2; max_evolution: Integer = 200; area_threshold: Double = 1.01; min_margin: Double = 0.003; edge_blur_size: Integer = 5): TCvMSERParams; cdecl;
  TcvPseudoInverse = function(const src: PCvArr; dst: PCvArr): Double; cdecl;
  TcvSumPixels = function(const image: PCvArr): Double; cdecl;
  TcvSURFParams_ = function(hessianThreshold: Double; _extended: Integer = 0): TCvSURFParams; cdecl;
  ...
  TcvCalibrateCamera = procedure(image_count: Integer; Var _point_counts: Integer; image_size: TCvSize; _image_points: PCvPoint2D32f; _object_points: PCvPoint3D32f; _distortion_coeffs: PSingle; _camera_matrix: PSingle; _translation_vectors: PSingle; _rotation_matrices: PSingle; flags: Integer); cdecl;
  TcvCalibrateCamera_64d = procedure(image_count: Integer; Var _point_counts: Integer; image_size: TCvSize; _image_points: PCvPoint2D64f; _object_points: PCvPoint3D64f; _distortion_coeffs: PDouble; _camera_matrix: PDouble; _translation_vectors: PDouble; _rotation_matrices: PDouble; flags: Integer); cdecl;
  TcvCircleAA = procedure(img: PCvArr; center: TCvPoint; radius: Integer; color: Double; scale: Integer = 0); cdecl;
  TcvConvexHull = procedure(points: PCvPoint; num_points: Integer; bound_rect: PCvRect; orientation: Integer; Var hull: Integer; Var hullsize: Integer); cdecl;
  TcvEllipseAA = procedure(img: PCvArr; center: TCvPoint; axes: TCvSize; angle: Double; start_angle: Double; end_angle: Double; color: Double; scale: Integer = 0); cdecl;
  ...
  TcvExtractSURF = procedure(const img: PCvArr; const mask: PCvArr; keypoints: ppCvSeq; descriptors: ppCvSeq; storage: PCvMemStorage; params: TCvSURFParams; useProvidedKeyPts: Integer = 0); cdecl;
  TcvFillImage = procedure(mat: PCvArr; color: Double); cdecl;
  TcvFindExtrinsicCameraParams = procedure(point_count: Integer; image_size: TCvSize; _image_points: PCvPoint2D32f; _object_points: PCvPoint3D32f; focal_length: PSingle; principal_point: TCvPoint2D32f; _distortion_coeffs: PSingle; _rotation_vector: PSingle; _translation_vector: PSingle); cdecl;
  TcvFindExtrinsicCameraParams_64d = procedure(point_count: Integer; image_size: TCvSize; _image_points: PCvPoint2D64f; _object_points: PCvPoint3D64f; focal_length: PDouble; principal_point: TCvPoint2D64f; _distortion_coeffs: PDouble; _rotation_vector: PDouble; _translation_vector: PDouble); cdecl;
  TcvFindFundamentalMatrix = procedure(Var points1: Integer; Var points2: Integer; numpoints: Integer; method: Integer; Var matrix: Single); cdecl;
  TcvFitEllipse = procedure(const points: PCvPoint2D32f; count: Integer; Var box: TCvBox2D); cdecl;
  TcvFitLine2D = procedure(points: PCvPoint2D32f; count: Integer; dist: Integer; param: Pointer; reps: Single; aeps: Single; Var line: Single); cdecl;
  TcvFitLine3D = procedure(points: PCvPoint3D32f; count: Integer; dist: Integer; param: Pointer; reps: Single; aeps: Single; Var line: Single); cdecl;
  TcvKMeans = procedure(num_clusters: Integer; Var samples: PSingle; num_samples: Integer; vec_size: Integer; termcrit: TCvTermCriteria; Var cluster_idx: Integer); cdecl;
  ...
  TcvMinAreaRect = procedure(points: PCvPoint; n: Integer; left: Integer; bottom: Integer; right: Integer; top: Integer; anchor: PCvPoint2D32f; vect1: PCvPoint2D32f; vect2: PCvPoint2D32f); cdecl;
  TcvmPerspectiveProject = procedure(const mat: PCvMat; const src: PCvArr; dst: PCvArr); cdecl;
  TcvPolyLineAA = procedure(img: PCvArr; Var pts: PCvPoint; Var npts: Integer; contours: Integer; is_closed: Integer; color: Double; scale: Integer = 0); cdecl;
  TcvProject3D = procedure(points3D: PCvPoint3D32f; count: Integer; points2D: PCvPoint2D32f; xIndx: Integer = 0; yIndx: Integer = 1); cdecl;
  TcvProjectPoints = procedure(point_count: Integer; _object_points: PCvPoint3D64f; _rotation_vector: PDouble; _translation_vector: PDouble; focal_length: PDouble; principal_point: TCvPoint2D64f; _distortion: PDouble; _image_points: PCvPoint2D64f; _deriv_points_rotation_matrix: PDouble; _deriv_points_translation_vect: PDouble; _deriv_points_focal: PDouble; _deriv_points_principal_point: PDouble; _deriv_points_distortion_coeffs: PDouble); cdecl;
  TcvProjectPointsSimple = procedure(point_count: Integer; _object_points: PCvPoint3D64f; _rotation_matrix: PDouble; _translation_vector: PDouble; _camera_matrix: PDouble; _distortion: PDouble; _image_points: PCvPoint2D64f); cdecl;
  ...
  TcvStartScanGraph = procedure(graph: PCvGraph; scanner: PCvGraphScanner; vtx: PCvGraphVtx = nil; mask: Integer = CV_GRAPH_ALL_ITEMS); cdecl;
  TcvUnDistort = procedure(const src: PCvArr; dst: PCvArr; const undistortion_map: PCvArr; interpolate: Integer); cdecl;
  TcvUnDistortInit = procedure(const src: PCvArr; undistortion_map: PCvArr; const A: PSingle; const k: PSingle; interpolate: Integer); cdecl;
  TcvUnDistortOnce = procedure(const src: PCvArr; dst: PCvArr; const intrinsic_matrix: PSingle; const distortion_coeffs: PSingle; interpolate: Integer); cdecl;
...
var
  ...
  cvMatArray: TcvMatArray_;
  cvMean: TcvMean;
  cvMSERParams: TcvMSERParams_;
  cvPseudoInverse: TcvPseudoInverse;
  cvSumPixels: TcvSumPixels;
  cvSURFParams: TcvSURFParams_;
...
procedure Initialize(const Handle: {$IFDEF FPC}TLibHandle{$ELSE}THandle{$IFEND}; const RaiseError: Boolean);
begin
  cvCalcEMD := GetProcAddress(Handle, 'cvCalcEMD', RaiseError);
  cvContourBoundingRect := GetProcAddress(Handle, 'cvContourBoundingRect', RaiseError);
  cvFindChessBoardCornerGuesses := GetProcAddress(Handle, 'cvFindChessBoardCornerGuesses', RaiseError);
  cvGetStarKeypoints := GetProcAddress(Handle, 'cvGetStarKeypoints', RaiseError);
  cvHoughLines := GetProcAddress(Handle, 'cvHoughLines', RaiseError);
  cvHoughLinesP := GetProcAddress(Handle, 'cvHoughLinesP', RaiseError);
  cvHoughLinesSDiv := GetProcAddress(Handle, 'cvHoughLinesSDiv', RaiseError);
  cvMatArray := GetProcAddress(Handle, 'cvMatArray', RaiseError);
  cvMean := GetProcAddress(Handle, 'cvMean', RaiseError);
  cvMSERParams := GetProcAddress(Handle, 'cvMSERParams', RaiseError);
  cvPseudoInverse := GetProcAddress(Handle, 'cvPseudoInverse', RaiseError);
  cvSumPixels := GetProcAddress(Handle, 'cvSumPixels', RaiseError);
  cvSURFParams := GetProcAddress(Handle, 'cvSURFParams', RaiseError);
  cvbCartToPolar := GetProcAddress(Handle, 'cvbCartToPolar', RaiseError);
  cvbFastArctan := GetProcAddress(Handle, 'cvbFastArctan', RaiseError);
  cvbFastExp := GetProcAddress(Handle, 'cvbFastExp', RaiseError);
  cvbFastLog := GetProcAddress(Handle, 'cvbFastLog', RaiseError);
  cvbInvSqrt := GetProcAddress(Handle, 'cvbInvSqrt', RaiseError);
  cvbRand := GetProcAddress(Handle, 'cvbRand', RaiseError);
  cvbReciprocal := GetProcAddress(Handle, 'cvbReciprocal', RaiseError);
  cvbSqrt := GetProcAddress(Handle, 'cvbSqrt', RaiseError);
  cvCalibrateCamera := GetProcAddress(Handle, 'cvCalibrateCamera', RaiseError);
  cvCalibrateCamera_64d := GetProcAddress(Handle, 'cvCalibrateCamera_64d', RaiseError);
  cvCircleAA := GetProcAddress(Handle, 'cvCircleAA', RaiseError);
  cvConvexHull := GetProcAddress(Handle, 'cvConvexHull', RaiseError);
  cvEllipseAA := GetProcAddress(Handle, 'cvEllipseAA', RaiseError);
  cvEndScanGraph := GetProcAddress(Handle, 'cvEndScanGraph', RaiseError);
  cvExtractMSER := GetProcAddress(Handle, 'cvExtractMSER', RaiseError);
  cvExtractSURF := GetProcAddress(Handle, 'cvExtractSURF', RaiseError);
  cvFillImage := GetProcAddress(Handle, 'cvFillImage', RaiseError);
  cvFindExtrinsicCameraParams := GetProcAddress(Handle, 'cvFindExtrinsicCameraParams', RaiseError);
  cvFindExtrinsicCameraParams_64d := GetProcAddress(Handle, 'cvFindExtrinsicCameraParams_64d', RaiseError);
  cvFindFundamentalMatrix := GetProcAddress(Handle, 'cvFindFundamentalMatrix', RaiseError);
  cvFitEllipse := GetProcAddress(Handle, 'cvFitEllipse', RaiseError);
  cvFitLine2D := GetProcAddress(Handle, 'cvFitLine2D', RaiseError);
  cvFitLine3D := GetProcAddress(Handle, 'cvFitLine3D', RaiseError);
  cvKMeans := GetProcAddress(Handle, 'cvKMeans', RaiseError);
  cvLineAA := GetProcAddress(Handle, 'cvLineAA', RaiseError);
  cvMean_StdDev := GetProcAddress(Handle, 'cvMean_StdDev', RaiseError);
  cvMinAreaRect := GetProcAddress(Handle, 'cvMinAreaRect', RaiseError);
  cvmPerspectiveProject := GetProcAddress(Handle, 'cvmPerspectiveProject', RaiseError);
  cvPolyLineAA := GetProcAddress(Handle, 'cvPolyLineAA', RaiseError);
  cvProject3D := GetProcAddress(Handle, 'cvProject3D', RaiseError);
  cvProjectPoints := GetProcAddress(Handle, 'cvProjectPoints', RaiseError);
  cvProjectPointsSimple := GetProcAddress(Handle, 'cvProjectPointsSimple', RaiseError);
  cvRand := GetProcAddress(Handle, 'cvRand', RaiseError);
  cvRandInit := GetProcAddress(Handle, 'cvRandInit', RaiseError);
  cvRandSetRange := GetProcAddress(Handle, 'cvRandSetRange', RaiseError);
  cvRodrigues := GetProcAddress(Handle, 'cvRodrigues', RaiseError);
  cvStartScanGraph := GetProcAddress(Handle, 'cvStartScanGraph', RaiseError);
  cvUnDistort := GetProcAddress(Handle, 'cvUnDistort', RaiseError);
  cvUnDistortInit := GetProcAddress(Handle, 'cvUnDistortInit', RaiseError);
  cvUnDistortOnce := GetProcAddress(Handle, 'cvUnDistortOnce', RaiseError);
end;
...
begin
  ...
  pos.width := roi.width;
  pos.height := roi.height;
  pos.bottomline := ocv.core.types_c.PUChar(origin + pos.step * pos.height);
  pos.topline := ocv.core.types_c.PUChar(origin - pos.step);
  pos.step_arr[0] := 0;
  pos.step_arr[1] := -pos.step;
  pos.step_arr[2] := pos.step;
  pos.x := _x;
  pos.currline := ocv.core.types_c.PUChar(origin + pos.step * _y);
end;
...
begin
  ...
  pos.width := roi.width;
  pos.height := roi.height;
  pos.bottomline := System.PSingle(origin + pos.step * pos.height);
  pos.topline := System.PSingle(origin - pos.step);
  pos.step_arr[0] := 0;
  pos.step_arr[1] := -pos.step;
  pos.step_arr[2] := pos.step;
  pos.x := _x;
  pos.currline := System.PSingle(origin + pos.step * _y);
end;
{$ENDIF}

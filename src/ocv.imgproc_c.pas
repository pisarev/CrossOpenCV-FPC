...
type
  Tcv2DRotationMatrix = function(center: TCvPoint2D32f; angle: Double; scale: Double; map_matrix: pCvMat): pCvMat; cdecl;
  ...
  TcvArcLength = function(const curve: Pointer; slice: TCvSlice ; is_closed: Integer  ): Double; cdecl;
  TcvBoundingRect = function(points: PCvArr; update: Integer = 0): TCvRect; cdecl;
  ...
  TcvContourArea = function(const contour: PCvArr; slice: TCvSlice ; oriented: Integer = 0): Double; cdecl;
  ...
  TcvEndFindContours = function(Var scanner: pCvContourScanner): pCvSeq; cdecl;
  TcvFindContours = function(image: PCvArr; storage: pCvMemStorage; first_contour: pCvSeq; header_size: Integer ; mode: Integer ; method: Integer ; offset: TCvPoint  ): Integer; cdecl;
  TcvFindNextContour = function(scanner: pCvContourScanner): pCvSeq; cdecl;
  TcvFitEllipse2 = function(const points: PCvArr): TCvBox2D; cdecl;
  TcvGetAffineTransform = function(const src: pCvPoint2D32f; const dst: pCvPoint2D32f; map_matrix: pCvMat): pCvMat; cdecl;
  TcvGetCentralMoment = function(moments: pCvMoments; x_order, y_order: Integer): Double; cdecl;
  TcvGetNormalizedCentralMoment = function(moments: pCvMoments; x_order: Integer; y_order: Integer): Double; cdecl;
  TcvGetPerspectiveTransform = function(const src: pCvPoint2D32f; const dst: pCvPoint2D32f; map_matrix: pCvMat): pCvMat; cdecl;
  TcvGetSpatialMoment = function(moments: pCvMoments; x_order, y_order: Integer): Double; cdecl;
  TcvHoughCircles = function(image: PCvArr; circle_storage: Pointer; method: Integer; dp: Double; min_dist: Double; param1: Double = 100; param2: Double = 100; min_radius: Integer = 0; max_radius: Integer = 0): pCvSeq; cdecl;
  TcvHoughLines2 = function(image: PCvArr; line_storage: Pointer; method: Integer; rho: Double; theta: Double; threshold: Integer; param1: Double = 0; param2: Double = 0): pCvSeq; cdecl;
  TcvMakeHistHeaderForArray = function(dims: Integer; sizes: PInteger; hist: pCvHistogram; data: pfloat; ranges: ppfloat = nil; uniform: Integer = 1): pCvHistogram; cdecl;
  TcvMatchShapes = function(const object1: Pointer; const object2: Pointer; method: Integer; parameter: Double = 0): Double; cdecl;
  TcvMaxRect = function(const rect1: pCvRect; const rect2: pCvRect): TCvRect; cdecl;
  TcvMinAreaRect2 = function(points: PCvArr; storage: pCvMemStorage = nil): TCvBox2D; cdecl;
  TcvMinEnclosingCircle = function(points: PCvArr; center: pCvPoint2D32f; radius: pSingle): Integer; cdecl;
  TcvPointPolygonTest = function(const contour: PCvArr; pt: TCvPoint2D32f; measure_dist: Integer): Double; cdecl;
  TcvPointSeqFromMat = function(seq_kind: Integer; const mat: PCvArr; contour_header: pCvContour; block: pCvSeqBlock): pCvSeq; cdecl;
  TcvReadChainPoint = function(reader: pCvChainPtReader): TCvPoint; cdecl;
  TcvSampleLine = function(const image: PCvArr; pt1: TCvPoint; pt2: TCvPoint; buffer: Pointer; connectivity: Integer = 8): Integer; cdecl;
  TcvStartFindContours = function(image: PCvArr; storage: pCvMemStorage; header_size: Integer ; mode: Integer ; method: Integer ; offset: TCvPoint  ): pCvContourScanner; cdecl;
  TcvThreshold = function(const src, dst: PCvArr; threshold, max_value: Double; threshold_type: Integer): Double; cdecl;
  ...
  TcvBoxPoints = procedure(box: TCvBox2D; pt: TBoxPoints); cdecl;
  TcvCalcArrBackProject = procedure(var image: PCvArr; dst: PCvArr; const hist: pCvHistogram); cdecl;
  TcvCalcArrBackProjectPatch = procedure(var image: PCvArr; dst: PCvArr; range: TCvSize; hist: pCvHistogram; method: Integer; factor: Double); cdecl;
  TcvCalcArrHist = procedure(var arr: pIplImage; hist: pCvHistogram; accumulate: Integer = 0; const mask: pIplImage = nil); cdecl;
  TcvCalcBackProject = procedure(var image: pIplImage; dst: PCvArr; const hist: pCvHistogram); cdecl;
  ...
  TcvCopyMakeBorder = procedure(const src: PCvArr; dst: PCvArr; offset: TCvPoint; bordertype: Integer; value: TCvScalar  ); cdecl;
  ...
  TcvCvtColor = procedure(const src: pIplImage; dst: pIplImage; code: Integer); cdecl;
  TcvDilate = procedure(const src: PCvArr; dst: PCvArr; element: pIplConvKernel = nil; iterations: Integer = 1); cdecl;
  TcvDistTransform = procedure(const src: PCvArr; dst: PCvArr; distance_type: Integer = CV_DIST_L2; mask_size: Integer = 3; const mask: pfloat = nil; labels: PCvArr = nil; labelType: Integer = CV_DIST_LABEL_CCOMP); cdecl;
  TcvEqualizeHist = procedure(const src, dst: PCvArr); cdecl;
  TcvErode = procedure(const src: PCvArr; dst: PCvArr; element: pIplConvKernel = nil; iterations: Integer = 1); cdecl;
  TcvFilter2D = procedure(const src: PCvArr; dst: PCvArr; const kernel: pCvMat; anchor: TCvPoint); cdecl;
  TcvFindCornerSubPix = procedure(const image: PCvArr; corners: pCvPoint2D32f; count: Integer; win: TCvSize; zero_zone: TCvSize; criteria: TCvTermCriteria); cdecl;
  TcvFitLine = procedure(const points: PCvArr; dist_type: Integer; param: Double; reps: Double; aeps: Double; Var line: Single); cdecl;
  TcvFloodFill = procedure(image: PCvArr; seed_point: TCvPoint; new_val: TCvScalar; lo_diff: TCvScalar ; up_diff: TCvScalar ; comp: pCvConnectedComp = NIL; flags: Integer = 4; mask: PCvArr = NIL); cdecl;
  TcvGetHuMoments = procedure(moments: pCvMoments; hu_moments: pCvHuMoments); cdecl;
  TcvGetMinMaxHistValue = procedure(const hist: pCvHistogram; min_value: pSingle; max_value: pSingle; min_idx: PInteger = nil; max_idx: PInteger = nil); cdecl;
  TcvGetQuadrangleSubPix = procedure(const src: PCvArr; dst: PCvArr; const map_matrix: pCvMat); cdecl;
  TcvGetRectSubPix = procedure(const src: PCvArr; dst: PCvArr; center: TCvPoint2D32f); cdecl;
  TcvGoodFeaturesToTrack = procedure(const image: PCvArr; eig_image: PCvArr; temp_image: PCvArr; corners: pCvPoint2D32f; corner_count: PInteger; quality_level: Double; min_distance: Double; const mask: PCvArr = nil; block_size: Integer = 3; use_harris: Integer = 0; k: Double = 0.04); cdecl;
  TcvInitUndistortMap = procedure(const camera_matrix: pCvMat; const distortion_coeffs: pCvMat; mapx: PCvArr; mapy: PCvArr); cdecl;
  TcvInitUndistortRectifyMap = procedure(const camera_matrix: pCvMat; const dist_coeffs: pCvMat; const R: pCvMat; const new_camera_matrix: pCvMat; mapx: PCvArr; mapy: PCvArr); cdecl;
  TcvIntegral = procedure(const image: PCvArr; sum: PCvArr; sqsum: PCvArr = NIL; tilted_sum: PCvArr = NIL); cdecl;
  TcvLaplace = procedure(const src: PCvArr; dst: PCvArr; aperture_size: Integer = 3); cdecl;
  TcvLinearPolar = procedure(const src: PCvArr; dst: PCvArr; center: TCvPoint2D32f; maxRadius: Double; flags: Integer = CV_INTER_LINEAR + CV_WARP_FILL_OUTLIERS); cdecl;
  TcvLogPolar = procedure(const src: PCvArr; dst: PCvArr; center: TCvPoint2D32f; M: Double; flags: Integer = CV_INTER_LINEAR + CV_WARP_FILL_OUTLIERS); cdecl;
  TcvMatchTemplate = procedure(const image: PCvArr; const templ: PCvArr; result: PCvArr; method: Integer); cdecl;
  TcvMoments = procedure(const arr: PCvArr; moments: pCvMoments; binary: Integer = 0); cdecl;
  TcvMorphologyEx = procedure(const src: PCvArr; dst: PCvArr; temp: PCvArr; element: pIplConvKernel; operation: Integer; iterations: Integer = 1); cdecl;
  TcvMultiplyAcc = procedure(const image1: PCvArr; const image2: PCvArr; acc: PCvArr; const mask: PCvArr = nil); cdecl;
  TcvNormalizeHist = procedure(hist: pCvHistogram; factor: Double); cdecl;
  TcvPreCornerDetect = procedure(const image: PCvArr; corners: PCvArr; aperture_size: Integer = 3); cdecl;
  TcvPyrDown = procedure(const src: PCvArr; dst: PCvArr; filter: Integer = CV_GAUSSIAN_5x5); cdecl;
  TcvPyrMeanShiftFiltering = procedure(const src: PCvArr; dst: PCvArr; sp: Double; sr: Double; max_level: Integer ; termcrit: TCvTermCriteria  ); cdecl;
  TcvPyrUp = procedure(const src: PCvArr; dst: PCvArr; filter: Integer = CV_GAUSSIAN_5x5); cdecl;
  TcvReleaseHist = procedure(Var hist: pCvHistogram); cdecl;
  TcvReleasePyramid = procedure(var pyramid: ppCvMat; extra_layers: Integer); cdecl;
  TcvReleaseStructuringElement = procedure(Var element: pIplConvKernel); cdecl;
  TcvRemap = procedure(const src: PCvArr; dst: PCvArr; const mapx: PCvArr; const mapy: PCvArr; flags: Integer ; fillval: TCvScalar  ); cdecl;
  TcvResize = procedure(const src: PCvArr; dst: PCvArr; interpolation: Integer = CV_INTER_LINEAR); cdecl;
  TcvRunningAvg = procedure(const image: PCvArr; acc: PCvArr; alpha: Double; const mask: PCvArr = nil); cdecl;
  TcvSetHistBinRanges = procedure(hist: pCvHistogram; ranges: pSingle; uniform: Integer = 1); cdecl;
  TcvSmooth = procedure(const src: PCvArr; dst: PCvArr; smoothtype: Integer = CV_GAUSSIAN; size1: Integer = 3; size2: Integer = 0; sigma1: Double = 0; sigma2: Double = 0); cdecl;
  TcvSobel = procedure(const src: PCvArr; dst: PCvArr; xorder: Integer; yorder: Integer; aperture_size: Integer = 3); cdecl;
  TcvSquareAcc = procedure(const image: PCvArr; sqsum: PCvArr; const mask: PCvArr = nil); cdecl;
  TcvStartReadChainPoints = procedure(chain: pCvChain; reader: pCvChainPtReader); cdecl;
  TcvSubstituteContour = procedure(scanner: pCvContourScanner; new_contour: pCvSeq); cdecl;
  TcvThreshHist = procedure(hist: pCvHistogram; threshold: Double); cdecl;
  TcvUndistort2 = procedure(const src: PCvArr; dst: PCvArr; const camera_matrix: PCvArr; const distortion_coeffs: PCvArr; const new_camera_matrix: PCvArr = nil); cdecl;
  TcvUndistortPoints = procedure(const src: pCvMat; dst: pCvMat; const camera_matrix: pCvMat; const dist_coeffs: pCvMat; const R: pCvMat = nil; const P: pCvMat = nil); cdecl;
  TcvWarpAffine = procedure(const src: PCvArr; dst: PCvArr; const map_matrix: pCvMat; flags: Integer ; fillval: TCvScalar  ); cdecl;
  TcvWarpPerspective = procedure(const src: PCvArr; dst: PCvArr; const map_matrix: pCvMat; flags: Integer ; fillval: TCvScalar  ); cdecl;
  TcvWatershed = procedure(const image: PCvArr; markers: PCvArr); cdecl;

var
  cv2DRotationMatrix: Tcv2DRotationMatrix;
  cvApproxChains: TcvApproxChains;
  cvApproxPoly: TcvApproxPoly;
  cvArcLength: TcvArcLength;
  cvBoundingRect: TcvBoundingRect;
  cvCalcEMD2: TcvCalcEMD2;
  cvCheckContourConvexity: TcvCheckContourConvexity;
  cvCompareHist: TcvCompareHist;
  cvContourArea: TcvContourArea;
  cvConvexHull2: TcvConvexHull2;
  cvConvexityDefects: TcvConvexityDefects;
  cvCreateHist: TcvCreateHist;
  cvCreatePyramid: TcvCreatePyramid;
  cvCreateStructuringElementEx: TcvCreateStructuringElementEx;
  cvEndFindContours: TcvEndFindContours;
  cvFindContours: TcvFindContours;
  cvFindNextContour: TcvFindNextContour;
  cvFitEllipse2: TcvFitEllipse2;
  cvGetAffineTransform: TcvGetAffineTransform;
  cvGetCentralMoment: TcvGetCentralMoment;
  cvGetNormalizedCentralMoment: TcvGetNormalizedCentralMoment;
  cvGetPerspectiveTransform: TcvGetPerspectiveTransform;
  cvGetSpatialMoment: TcvGetSpatialMoment;
  cvHoughCircles: TcvHoughCircles;
  cvHoughLines2: TcvHoughLines2;
  cvMakeHistHeaderForArray: TcvMakeHistHeaderForArray;
  cvMatchShapes: TcvMatchShapes;
  cvMaxRect: TcvMaxRect;
  cvMinAreaRect2: TcvMinAreaRect2;
  cvMinEnclosingCircle: TcvMinEnclosingCircle;
  cvPointPolygonTest: TcvPointPolygonTest;
  cvPointSeqFromMat: TcvPointSeqFromMat;
  cvReadChainPoint: TcvReadChainPoint;
  cvSampleLine: TcvSampleLine;
  cvStartFindContours: TcvStartFindContours;
  cvThreshold: TcvThreshold;
  cvAcc: TcvAcc;
  cvAdaptiveThreshold: TcvAdaptiveThreshold;
  cvBoxPoints: TcvBoxPoints;
  cvCalcArrBackProject: TcvCalcArrBackProject;
  cvCalcArrBackProjectPatch: TcvCalcArrBackProjectPatch;
  cvCalcArrHist: TcvCalcArrHist;
  cvCalcBackProject: TcvCalcBackProject;
  cvCalcBayesianProb: TcvCalcBayesianProb;
  cvCalcProbDensity: TcvCalcProbDensity;
  cvCanny: TcvCanny;
  cvClearHist: TcvClearHist;
  cvConvertMaps: TcvConvertMaps;
  cvCopyHist: TcvCopyHist;
  cvCopyMakeBorder: TcvCopyMakeBorder;
  cvCornerEigenValsAndVecs: TcvCornerEigenValsAndVecs;
  cvCornerHarris: TcvCornerHarris;
  cvCornerMinEigenVal: TcvCornerMinEigenVal;
  cvCvtColor: TcvCvtColor;
  cvDilate: TcvDilate;
  cvDistTransform: TcvDistTransform;
  cvEqualizeHist: TcvEqualizeHist;
  cvErode: TcvErode;
  cvFilter2D: TcvFilter2D;
  cvFindCornerSubPix: TcvFindCornerSubPix;
  cvFitLine: TcvFitLine;
  cvFloodFill: TcvFloodFill;
  cvGetHuMoments: TcvGetHuMoments;
  cvGetMinMaxHistValue: TcvGetMinMaxHistValue;
  cvGetQuadrangleSubPix: TcvGetQuadrangleSubPix;
  cvGetRectSubPix: TcvGetRectSubPix;
  cvGoodFeaturesToTrack: TcvGoodFeaturesToTrack;
  cvInitUndistortMap: TcvInitUndistortMap;
  cvInitUndistortRectifyMap: TcvInitUndistortRectifyMap;
  cvIntegral: TcvIntegral;
  cvLaplace: TcvLaplace;
  cvLinearPolar: TcvLinearPolar;
  cvLogPolar: TcvLogPolar;
  cvMatchTemplate: TcvMatchTemplate;
  cvMoments: TcvMoments;
  cvMorphologyEx: TcvMorphologyEx;
  cvMultiplyAcc: TcvMultiplyAcc;
  cvNormalizeHist: TcvNormalizeHist;
  cvPreCornerDetect: TcvPreCornerDetect;
  cvPyrDown: TcvPyrDown;
  cvPyrMeanShiftFiltering: TcvPyrMeanShiftFiltering;
  cvPyrUp: TcvPyrUp;
  cvReleaseHist: TcvReleaseHist;
  cvReleasePyramid: TcvReleasePyramid;
  cvReleaseStructuringElement: TcvReleaseStructuringElement;
  cvRemap: TcvRemap;
  cvResize: TcvResize;
  cvRunningAvg: TcvRunningAvg;
  cvSetHistBinRanges: TcvSetHistBinRanges;
  cvSmooth: TcvSmooth;
  cvSobel: TcvSobel;
  cvSquareAcc: TcvSquareAcc;
  cvStartReadChainPoints: TcvStartReadChainPoints;
  cvSubstituteContour: TcvSubstituteContour;
  cvThreshHist: TcvThreshHist;
  cvUndistort2: TcvUndistort2;
  cvUndistortPoints: TcvUndistortPoints;
  cvWarpAffine: TcvWarpAffine;
  cvWarpPerspective: TcvWarpPerspective;
  cvWatershed: TcvWatershed;
...
const
  ImgProcLibName = imgproc_lib;
var
  ImgProcLibHandle: {$IFDEF FPC}TLibHandle{$ELSE}THandle{$IFEND};

implementation

uses
  {$IFDEF FPC}
  {$IFDEF MSWINDOWS}Windows, {$ENDIF}{$IFDEF FPC}dynlibs, {$ENDIF}SysUtils, VersionUtils;
  {$ELSE}
...
procedure Initialize(const Handle: {$IFDEF FPC}TLibHandle{$ELSE}THandle{$IFEND}; const RaiseError: Boolean);
begin
  cv2DRotationMatrix := GetProcAddress(Handle, 'cv2DRotationMatrix', RaiseError);
  cvApproxChains := GetProcAddress(Handle, 'cvApproxChains', RaiseError);
  cvApproxPoly := GetProcAddress(Handle, 'cvApproxPoly', RaiseError);
  cvArcLength := GetProcAddress(Handle, 'cvArcLength', RaiseError);
  cvBoundingRect := GetProcAddress(Handle, 'cvBoundingRect', RaiseError);
  cvCalcEMD2 := GetProcAddress(Handle, 'cvCalcEMD2', RaiseError);
  cvCheckContourConvexity := GetProcAddress(Handle, 'cvCheckContourConvexity', RaiseError);
  cvCompareHist := GetProcAddress(Handle, 'cvCompareHist', RaiseError);
  cvContourArea := GetProcAddress(Handle, 'cvContourArea', RaiseError);
  cvConvexHull2 := GetProcAddress(Handle, 'cvConvexHull2', RaiseError);
  cvConvexityDefects := GetProcAddress(Handle, 'cvConvexityDefects', RaiseError);
  cvCreateHist := GetProcAddress(Handle, 'cvCreateHist', RaiseError);
  cvCreatePyramid := GetProcAddress(Handle, 'cvCreatePyramid', RaiseError);
  cvCreateStructuringElementEx := GetProcAddress(Handle, 'cvCreateStructuringElementEx', RaiseError);
  cvEndFindContours := GetProcAddress(Handle, 'cvEndFindContours', RaiseError);
  cvFindContours := GetProcAddress(Handle, 'cvFindContours', RaiseError);
  cvFindNextContour := GetProcAddress(Handle, 'cvFindNextContour', RaiseError);
  cvFitEllipse2 := GetProcAddress(Handle, 'cvFitEllipse2', RaiseError);
  cvGetAffineTransform := GetProcAddress(Handle, 'cvGetAffineTransform', RaiseError);
  cvGetCentralMoment := GetProcAddress(Handle, 'cvGetCentralMoment', RaiseError);
  cvGetNormalizedCentralMoment := GetProcAddress(Handle, 'cvGetNormalizedCentralMoment', RaiseError);
  cvGetPerspectiveTransform := GetProcAddress(Handle, 'cvGetPerspectiveTransform', RaiseError);
  cvGetSpatialMoment := GetProcAddress(Handle, 'cvGetSpatialMoment', RaiseError);
  cvHoughCircles := GetProcAddress(Handle, 'cvHoughCircles', RaiseError);
  cvHoughLines2 := GetProcAddress(Handle, 'cvHoughLines2', RaiseError);
  cvMakeHistHeaderForArray := GetProcAddress(Handle, 'cvMakeHistHeaderForArray', RaiseError);
  cvMatchShapes := GetProcAddress(Handle, 'cvMatchShapes', RaiseError);
  cvMaxRect := GetProcAddress(Handle, 'cvMaxRect', RaiseError);
  cvMinAreaRect2 := GetProcAddress(Handle, 'cvMinAreaRect2', RaiseError);
  cvMinEnclosingCircle := GetProcAddress(Handle, 'cvMinEnclosingCircle', RaiseError);
  cvPointPolygonTest := GetProcAddress(Handle, 'cvPointPolygonTest', RaiseError);
  cvPointSeqFromMat := GetProcAddress(Handle, 'cvPointSeqFromMat', RaiseError);
  cvReadChainPoint := GetProcAddress(Handle, 'cvReadChainPoint', RaiseError);
  cvSampleLine := GetProcAddress(Handle, 'cvSampleLine', RaiseError);
  cvStartFindContours := GetProcAddress(Handle, 'cvStartFindContours', RaiseError);
  cvThreshold := GetProcAddress(Handle, 'cvThreshold', RaiseError);
  cvAcc := GetProcAddress(Handle, 'cvAcc', RaiseError);
  cvAdaptiveThreshold := GetProcAddress(Handle, 'cvAdaptiveThreshold', RaiseError);
  cvBoxPoints := GetProcAddress(Handle, 'cvBoxPoints', RaiseError);
  cvCalcArrBackProject := GetProcAddress(Handle, 'cvCalcArrBackProject', RaiseError);
  cvCalcArrBackProjectPatch := GetProcAddress(Handle, 'cvCalcArrBackProjectPatch', RaiseError);
  cvCalcArrHist := GetProcAddress(Handle, 'cvCalcArrHist', RaiseError);
  cvCalcBackProject := GetProcAddress(Handle, 'cvCalcArrBackProject', RaiseError);
  cvCalcBayesianProb := GetProcAddress(Handle, 'cvCalcBayesianProb', RaiseError);
  cvCalcProbDensity := GetProcAddress(Handle, 'cvCalcProbDensity', RaiseError);
  cvCanny := GetProcAddress(Handle, 'cvCanny', RaiseError);
  cvClearHist := GetProcAddress(Handle, 'cvClearHist', RaiseError);
  cvConvertMaps := GetProcAddress(Handle, 'cvConvertMaps', RaiseError);
  cvCopyHist := GetProcAddress(Handle, 'cvCopyHist', RaiseError);
  cvCopyMakeBorder := GetProcAddress(Handle, 'cvCopyMakeBorder', RaiseError);
  cvCornerEigenValsAndVecs := GetProcAddress(Handle, 'cvCornerEigenValsAndVecs', RaiseError);
  cvCornerHarris := GetProcAddress(Handle, 'cvCornerHarris', RaiseError);
  cvCornerMinEigenVal := GetProcAddress(Handle, 'cvCornerMinEigenVal', RaiseError);
  cvCvtColor := GetProcAddress(Handle, 'cvCvtColor', RaiseError);
  cvDilate := GetProcAddress(Handle, 'cvDilate', RaiseError);
  cvDistTransform := GetProcAddress(Handle, 'cvDistTransform', RaiseError);
  cvEqualizeHist := GetProcAddress(Handle, 'cvEqualizeHist', RaiseError);
  cvErode := GetProcAddress(Handle, 'cvErode', RaiseError);
  cvFilter2D := GetProcAddress(Handle, 'cvFilter2D', RaiseError);
  cvFindCornerSubPix := GetProcAddress(Handle, 'cvFindCornerSubPix', RaiseError);
  cvFitLine := GetProcAddress(Handle, 'cvFitLine', RaiseError);
  cvFloodFill := GetProcAddress(Handle, 'cvFloodFill', RaiseError);
  cvGetHuMoments := GetProcAddress(Handle, 'cvGetHuMoments', RaiseError);
  cvGetMinMaxHistValue := GetProcAddress(Handle, 'cvGetMinMaxHistValue', RaiseError);
  cvGetQuadrangleSubPix := GetProcAddress(Handle, 'cvGetQuadrangleSubPix', RaiseError);
  cvGetRectSubPix := GetProcAddress(Handle, 'cvGetRectSubPix', RaiseError);
  cvGoodFeaturesToTrack := GetProcAddress(Handle, 'cvGoodFeaturesToTrack', RaiseError);
  cvInitUndistortMap := GetProcAddress(Handle, 'cvInitUndistortMap', RaiseError);
  cvInitUndistortRectifyMap := GetProcAddress(Handle, 'cvInitUndistortRectifyMap', RaiseError);
  cvIntegral := GetProcAddress(Handle, 'cvIntegral', RaiseError);
  cvLaplace := GetProcAddress(Handle, 'cvLaplace', RaiseError);
  cvLinearPolar := GetProcAddress(Handle, 'cvLinearPolar', RaiseError);
  cvLogPolar := GetProcAddress(Handle, 'cvLogPolar', RaiseError);
  cvMatchTemplate := GetProcAddress(Handle, 'cvMatchTemplate', RaiseError);
  cvMoments := GetProcAddress(Handle, 'cvMoments', RaiseError);
  cvMorphologyEx := GetProcAddress(Handle, 'cvMorphologyEx', RaiseError);
  cvMultiplyAcc := GetProcAddress(Handle, 'cvMultiplyAcc', RaiseError);
  cvNormalizeHist := GetProcAddress(Handle, 'cvNormalizeHist', RaiseError);
  cvPreCornerDetect := GetProcAddress(Handle, 'cvPreCornerDetect', RaiseError);
  cvPyrDown := GetProcAddress(Handle, 'cvPyrDown', RaiseError);
  cvPyrMeanShiftFiltering := GetProcAddress(Handle, 'cvPyrMeanShiftFiltering', RaiseError);
  cvPyrUp := GetProcAddress(Handle, 'cvPyrUp', RaiseError);
  cvReleaseHist := GetProcAddress(Handle, 'cvReleaseHist', RaiseError);
  cvReleasePyramid := GetProcAddress(Handle, 'cvReleasePyramid', RaiseError);
  cvReleaseStructuringElement := GetProcAddress(Handle, 'cvReleaseStructuringElement', RaiseError);
  cvRemap := GetProcAddress(Handle, 'cvRemap', RaiseError);
  cvResize := GetProcAddress(Handle, 'cvResize', RaiseError);
  cvRunningAvg := GetProcAddress(Handle, 'cvRunningAvg', RaiseError);
  cvSetHistBinRanges := GetProcAddress(Handle, 'cvSetHistBinRanges', RaiseError);
  cvSmooth := GetProcAddress(Handle, 'cvSmooth', RaiseError);
  cvSobel := GetProcAddress(Handle, 'cvSobel', RaiseError);
  cvSquareAcc := GetProcAddress(Handle, 'cvSquareAcc', RaiseError);
  cvStartReadChainPoints := GetProcAddress(Handle, 'cvStartReadChainPoints', RaiseError);
  cvSubstituteContour := GetProcAddress(Handle, 'cvSubstituteContour', RaiseError);
  cvThreshHist := GetProcAddress(Handle, 'cvThreshHist', RaiseError);
  cvUndistort2 := GetProcAddress(Handle, 'cvUndistort2', RaiseError);
  cvUndistortPoints := GetProcAddress(Handle, 'cvUndistortPoints', RaiseError);
  cvWarpAffine := GetProcAddress(Handle, 'cvWarpAffine', RaiseError);
  cvWarpPerspective := GetProcAddress(Handle, 'cvWarpPerspective', RaiseError);
  cvWatershed := GetProcAddress(Handle, 'cvWatershed', RaiseError);
end;
...
{$IFDEF USE_INLINE}inline; {$ENDIF} overload;
begin
  cvCalcArrHist(pIplImage(image), hist, accumulate, mask);
end;

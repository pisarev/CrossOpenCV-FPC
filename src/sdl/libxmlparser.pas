...
FUNCTION  Utf8ToAnsi  (Source : STRING; UnknownChar : CHAR = 'ї') : ANSISTRING;  // Convert UTF-8 to Win-1252
...
(* UTF-8  (somewhat simplified)
   ...
   Example
   --------
   Transforming the Unicode character U+00E4 LATIN SMALL LETTER A WITH DIAERESIS  ("д"):
